...
declare class Experience {
	 ...
	 */
	static readonly MAX_REAL_LEVEL: number;
	/**
	 * The maximum virtual skill level for any skill (200M experience).
	 */
	static readonly MAX_VIRT_LEVEL: number;
	static readonly MAX_SKILL_XP: number;
	/**
	 * The maximum possible combat level.
	 */
	static readonly MAX_COMBAT_LEVEL: number;
	/**
	 * The total experience required for each skill level.
	 */
	private static readonly XP_FOR_LEVEL;
	/**
