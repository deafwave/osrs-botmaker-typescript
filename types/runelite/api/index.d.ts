...
/// <reference path="./PacketBuffer.d.ts" />
...
/// <reference path="./ScriptArguments.d.ts" />
...
/// <reference path="./annotations/VisibleForExternalPlugins.d.ts" />
...
/// <reference path="./events/CanvasSizeChanged.d.ts" />
...
/// <reference path="./events/PostAnimation.d.ts" />
/// <reference path="./events/PostClientTick.d.ts" />
/// <reference path="./events/PostHealthBar.d.ts" />
/// <reference path="./events/PostItemComposition.d.ts" />
/// <reference path="./events/PostMenuSort.d.ts" />
/// <reference path="./events/PostObjectComposition.d.ts" />
...
/// <reference path="./events/UsernameChanged.d.ts" />
...
/// <reference path="./overlay/OverlayIndex.d.ts" />
...
interface RuneliteApi {
	AABB: AABB;
	Actor: Actor;
	ActorSpotAnim: ActorSpotAnim;
	...
	CollisionDataFlag: CollisionDataFlag;
	ColorTextureOverride: ColorTextureOverride;
	Constants: Constants;
	...
	GrandExchangeOfferState: GrandExchangeOfferState;
	GraphicID: GraphicID;
	GraphicsObject: GraphicsObject;
	GroundObject: GroundObject;
	HashTable: HashTable<any>;
	HeadIcon: HeadIcon;
	HealthBar: HealthBar;
	HintArrowType: HintArrowType;
	Hitsplat: Hitsplat;
	...
	ItemID: ItemID;
	ItemLayer: ItemLayer;
	IterableHashTable: IterableHashTable<any>;
	...
	Nameable: Nameable;
	NameableContainer: NameableContainer<any>;
	Node: RuneliteNode;
	NodeCache: NodeCache;
	NpcID: NpcID;
	...
	VarPlayer: VarPlayer;
	VarbitComposition: VarbitComposition;
	Varbits: Varbits;
	...
	annotations: {
		...
		VisibleForExternalPlugins: VisibleForExternalPlugins;
	};
	clan: {
	...
	dbtable: { DBRowConfig: DBRowConfig; DBTableID: DBTableID };
	events: {
		AccountHashChanged: AccountHashChanged;
		...
		DraggingWidgetChanged: DraggingWidgetChanged;
		...
		PostClientTick: PostClientTick;
		PostHealthBar: PostHealthBar;
		PostItemComposition: PostItemComposition;
		PostMenuSort: PostMenuSort;
	...
	hooks: { Callbacks: Callbacks; DrawCallbacks: DrawCallbacks };
	kit: { KitType: KitType };
	model: { Jarvis: Jarvis };
	overlay: { OverlayIndex: OverlayIndex };
	vars: { AccountType: AccountType; InputType: InputType };
	widgets: {
		ItemQuantityMode: ItemQuantityMode;
		...
		WidgetPositionMode: WidgetPositionMode;
		WidgetSizeMode: WidgetSizeMode;
		WidgetTextAlignment: WidgetTextAlignment;
		WidgetType: WidgetType;
		WidgetUtil: WidgetUtil;
	};
	worldmap: {
		MapElementConfig: MapElementConfig;
		WorldMap: WorldMap;
		WorldMapData: WorldMapData;
