...
The helper functions are designed to be allow for simple UI element, while incorporating methods for caching values directly to the bmCache, without much additional effort.
